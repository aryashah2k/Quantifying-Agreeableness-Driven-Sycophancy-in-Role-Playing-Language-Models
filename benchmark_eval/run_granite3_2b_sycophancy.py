#!/usr/bin/env python3
"""
Sycophancy Benchmark Inference Script for Granite-3.3-2B-Instruct
==================================================================
...
def build_messages_granite(system_content: str, user_content: str) -> list[dict]:
    """
    Build chat messages for Granite model with sycophancy evaluation instruction.
    Granite supports system prompts natively.
    """
    return [
    ...
    for batch_start in tqdm(range(0, len(data), BATCH_SIZE), desc="Processing", total=num_batches):
        ...
        for entry in batch_data:
            ...
            batch_messages.append(
                build_messages_granite(messages[0]["content"], messages[1]["content"])
            )
