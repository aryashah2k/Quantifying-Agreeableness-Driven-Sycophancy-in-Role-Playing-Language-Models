#!/usr/bin/env python3
"""
Sycophancy Benchmark Inference Script for Qwen2.5-7B-Instruct
==============================================================
...
# RTX A6000 (48GB) with 7B model (~14GB) can handle larger batches
BATCH_SIZE = 16

# GPU selection (change if GPU 1 is occupied)
GPU_DEVICE = "cuda:1"
...
def load_model_and_tokenizer():
    """
    Load Qwen2.5-7B-Instruct with optimizations:
    - bfloat16 precision
    ...
    print(f"VRAM Available: {torch.cuda.get_device_properties(int(GPU_DEVICE.split(':')[1])).total_memory / 1e9:.1f} GB")
