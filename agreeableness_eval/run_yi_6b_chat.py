#!/usr/bin/env python3
"""
Agreeableness Questionnaire Inference Script for Yi-6B-Chat
===========================================================
...
Note: Yi-6B is a BASE model (not instruction-tuned).
This script uses Yi-6B-Chat which is the instruction-tuned version.
...
def build_prompt(persona: str, question_text: str, prompt_template: dict) -> list[dict]:
    """Build chat messages for Yi model."""
