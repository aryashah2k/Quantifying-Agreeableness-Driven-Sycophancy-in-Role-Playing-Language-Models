#!/usr/bin/env python3
"""
Agreeableness Questionnaire Inference Script for LFM2-350M
==========================================================
...
Very small model (350M), allows very large batch sizes.
"""
...
# 350M model is extremely small (~700MB), can use very large batches
BATCH_SIZE = 64
...
def build_prompt(persona: str, question_text: str, prompt_template: dict) -> list[dict]:
    """Build chat messages for LFM2 model."""
...
def load_model_and_tokenizer():
    """
    Load LFM2-350M with optimizations:
    - bfloat16 precision
    - SDPA attention
    - Dynamic KV-cache
    """
